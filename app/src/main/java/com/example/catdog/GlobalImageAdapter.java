...
public class GlobalImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    Context mContext;
    List<Post> mPostList;

    public GlobalImageAdapter(Context mContext, List<Post> mPostList) {
    ...
    public ImageAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.global_posts_card_view, parent, false);
